...
import { BulletSpawner, BulletTemplate } from "./entities/bullet.js";
...
function main(ts) {
    ...
    const sorted_entities = Array.from(Entity.entities).sort((a, b) => a.layer - b.layer);
...
requestAnimationFrame(main);
function spawn(x) {
    const e = new Enemy(x, -30, 20, new Motion({
        angle: 90,
        speed: 100,
        acceleration: -20,
    }));
...
const timer = new Timer(50, (drift) => {
